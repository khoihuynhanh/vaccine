...
function Home() {
  ...
  const onSubmit = async (data) => {
    ...
    await axiosCli()
      .post("/doctor/booking", dataSubmit)
      .then((res) => {
        if (res.status == 200) {
          api.open({
  ...
  return (
    <div className="">
      ...
      <div className="mt-1">
        <img
          className="w-full"
          src="https://admin.medinet.gov.vn/UploadImages/soytehcm/2023_8/Tuyen%20dung/TTYTNB/hinh-ttytnb_88202322.jpg"
          alt=""
        />
      </div>
      <div
        className="grid grid-cols-2 m-auto mt-5 max-[1200px]:grid-cols-1"
        style={{ width: "95%" }}>
        <div className="max-[1200px]: w-full">
          <img
            src="https://binhphuoc.gov.vn/uploads/binhphuoc/news/2022_11/tiem-vac-xin.png"
            alt=""
          />
          <img
            src="https://healthpolicy.usc.edu/wp-content/uploads/2021/07/Email-cover-e1625707529984-1024x646.png"
            width={550}
            height={200}
            alt=""
          />
        ...
        <div className="">
          <div
            className="h-full shadow-md max-[1200px]:w-full max-[1200px]:mr-6 max-[1200px]:mt-10"
            ref={ref}>
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                <div className="mb-4">
                  ...
                  <input
                    ...
                    disabled={dataUser.fullname ? true : false}
                    id="fullname"
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    id="email"
                    disabled={dataUser.email ? true : false}
                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                  />
                </div>
                <div className="mb-4">
                  ...
                  <input
                    ...
                    disabled={dataUser.phone ? true : false}
                    id="phone"
                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    required
                  />
                ...
                <button
                  type="submit"
                  className="text-white mb-4 float-right bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center flex items-center">
